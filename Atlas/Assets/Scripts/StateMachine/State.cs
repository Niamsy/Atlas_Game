...
{
    public class State<TMonoBehaviour> : SealedStateMachine
        where TMonoBehaviour : MonoBehaviour
    {
        protected TMonoBehaviour _Actor;
        ...
        {
            State<TMonoBehaviour>[] sceneLinkedSMBs = animator.GetBehaviours<State<TMonoBehaviour>>();
    ...
    public abstract class SealedStateMachine : StateMachineBehaviour
    {
