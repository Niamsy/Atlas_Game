...
namespace Localization.Utilities
{
    public class GoogleTranslator
    {
        ...
        private UnityWebRequest PrepareRequest(GoogleTranslateRequest request)
        {
            ...
            form.AddField(RequestKeySourceLanguage, LocalizationManager.GetLanguageCode(request.Source));
            form.AddField(RequestKeyTargetLanguage, LocalizationManager.GetLanguageCode(request.Target));
